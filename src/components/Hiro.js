...
export default function Hiro() {
  ...
  return (
    <>
      ...
      >
        <div className="md:w-3/6 md:p-4  md:m-0">
          <img
            data-aos="flip-right"
        ...
        >
          <div className="flex flex-col w-full mt-8">
            ...
            <h1 className="text-2xl font-bold">Yhoni Mardusa</h1>
            <p class="text-xl font-bold text-gray-300">Full Stack Developer</p>
            <p className="text-md font-light text-gray-400 ">
              Enthusiastic and motivated to learn independently in Technology.
              Interested in learning about Web Development, API & Database. Now
              I'm looking more experience in my field.
            </p>
          </div>
          <ul className="flex mt-2 gap-4 items-center">
            <li>
              <a
                href="https://github.com/Yhonimard"
                rel="noreferrer"
                target="_blank"
              >
            ...
            <li>
              <a
                href="https://instagram.com/Yhonimard"
                rel="noreferrer"
                target="_blank"
              >
            ...
            <li>
              <a
                href="htps://linkedin.com/Yhonimard"
                rel="noreferrer"
                target="_blank"
              >
